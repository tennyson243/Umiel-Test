...
export const ORDER_TRANSACTION_CREATE_REQUEST =
  "ORDER_TRANSACTION_CREATE_REQUEST";
export const ORDER_TRANSACTION_CREATE_SUCCESS =
  "ORDER_TRANSACTION_CREATE_SUCCESS";
export const ORDER_TRANSACTION_CREATE_FAIL = "ORDER_TRANSACTION_CREATE_FAIL";
export const ORDER_TRANSACTION_CREATE_RESET = "ORDER_TRANSACTION_CREATE_RESET";
