...
export const GENERAL_DASHBOARD_REQUEST = "GENERAL_DASHBOARD_REQUEST";
export const GENERAL_DASHBOARD_SUCCESS = "GENERAL_DASHBOARD_SUCCESS";
export const GENERAL_DASHBOARD_FAIL = "GENERAL_DASHBOARD_FAIL";

export const OVERVIEUW_LIST_REQUEST = "OVERVIEUW_LIST_REQUEST";
export const OVERVIEUW_LIST_SUCCESS = "OVERVIEUW_LIST_SUCCESS";
export const OVERVIEUW_LIST_FAIL = "OVERVIEUW_LIST_FAIL";
